  ...
  async function handleSocialLogin(provider: 'google' | 'apple') {
    ...
    try {
      if (Capacitor.isNativePlatform()) {
        ...
        // 🚨 THE FIX: Force initialize exactly when the button is clicked!
        await SocialLogin.initialize({
          google: {
            webClientId: '733174050338-8eknm8lt8m5fmrbcic8nghjuhttmjh2j.apps.googleusercontent.com',
            // Notice the capital O and S in iOSClientId!
        ...
        // Trigger the native bottom-sheet login prompt
        ...
        // Pass the native token directly to Supabase
        ...
        // 2. WE ARE ON THE WEB (VERCEL) - KEEP OLD FLOW
