  ...
  async function handleSocialLogin(provider: 'google' | 'apple') {
    ...
    try {
      if (Capacitor.isNativePlatform()) {
        ...
        // 2. 🚨 THE FIX: Only add Apple config if the device is actually an iPhone!
        // This stops Android from crashing while looking for a redirectUrl.
        ...
        // Extract the secure token generated by the phone
