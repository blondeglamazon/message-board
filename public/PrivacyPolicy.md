...
We collect information that you voluntarily provide to us when you register on the App, create a user profile, or otherwise contact us.
...
* **Account Information:** Email address, username, and password (encrypted and managed securely via Supabase).
* **Profile Information:** Your display name, biography, and profile links (e.g., website, social media handles).
* **User-Generated Content:** Content you post, upload, or share on the App, including text posts, photos, videos, and embedded media links.

### B. Automatically Collected Information

We automatically collect certain information when you visit, use, or navigate the App. This information does not reveal your specific identity but may include device and usage information, such as:
...
* **App Functionality:** To facilitate account creation, maintain your profile, and allow you to post content.
* **User Communication:** To enable user-to-user communications (e.g., following users, viewing posts).
* **Safety & Moderation:** To manage user accounts, process reports, enforce our zero-tolerance moderation policies, and protect our services against fraud.
...
* **Publicly Visible Content:** Any content you post to your profile or feed is visible to other users of the App.
* **Service Providers:** We share data with third-party vendors who perform essential services for us, such as Supabase for authentication and database hosting.
...
In compliance with Apple App Store and Google Play Store guidelines, you have the right to request the complete deletion of your account and all associated personal data at any time.
